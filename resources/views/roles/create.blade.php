...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">{{ __('common.create_role') }}</h2>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input permission-checkbox group-{{ $group }}" type="checkbox" name="permissions[]" value="{{ $permission->name }}" id="perm_{{ $permission->id }}">
...
<script>
    $(document).ready(function() {
        ...
        $('.permission-checkbox').change(function() {
            ...
            var allChecked = $('.permission-checkbox.' + groupClass).length === $('.permission-checkbox.' + groupClass + ':checked').length;

...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">{{ __('about.create_service') }}</h1>
            <a href="{{ route('admin.services.index') }}" class="btn btn-secondary">{{ __('common.cancel') }}</a>
        </div>

        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" id="createServiceForm">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="front_title" id="front_title" class="form-control @error('front_title') is-invalid @enderror">
                                @error('front_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label for="front_image" class="form-label">{{ __('about.front_image') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="front_description" id="front_description" class="form-control summernote"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="back_image" class="form-label">{{ __('about.back_image') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="back_description" id="back_description" class="form-control summernote"></textarea>
                            </div>
                             <div class="mb-3">
